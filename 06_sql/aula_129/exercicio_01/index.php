...
if($form){
  ...
  $produtos = select_sql("SELECT * FROM produtos WHERE nome LIKE '%$pesquisa%'");
}else{
...
<form action="" class="caixa">
  <h3>Formulário</h3>
  <br>
  <input type="text" name="pesquisa" value="<?=$pesquisa?>" required placeholder="pesquisa">
  <br><br>
