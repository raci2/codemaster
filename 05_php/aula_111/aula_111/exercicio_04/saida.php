...
$form = !empty($_POST["nome"]) && !empty($_FILES["foto"]) && !empty($_POST["descricao"]) && isset($_POST["antes"]) && isset($_POST["depois"]);
if($form){
  $nome = $_POST["nome"];
  $descricao = $_POST["descricao"];
  $antes = intval($_POST["antes"]);
  $depois = intval($_POST["depois"]);
      ...
      <div class="col-12">
        ...
        <div class="perfil especial m-auto rounded-4 text-black my-4">
          <div class="container-fluid">
            <div class="row">
              <div class="col-4 px-0">
                <img src="<?= $destino ?>" alt="Imagem de Perfil" class="w-100 rounded-start-4">
              </div>
              <div class="col-8">
